...
def add_args_rcm(parser: argparse.ArgumentParser):
    ...
    #     default=False,
    #     action="store_true",
    #     help="Train the RCM with the Potts prior.",
    # )
    # rcm_args.add_argument(
    #     "--num_colors",
    #     type=int,
    #     default=21,
    #     help="(Defaults to 21). Number of colors for Potts variables.",
    # )
    # rcm_args.add_argument("--with_bias", default=False, action="store_true")
    return parser
